...
public class SystemMaintenanceController {
    ...
    @Operation(summary = "Get Database Storage Breakdown", description = "Inspects table sizes, free space, and InnoDB file sizes to diagnose Railway disk volume usage.")
